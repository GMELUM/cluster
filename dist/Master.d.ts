...
declare class Master<M extends BridgeMaster, C extends BridgeCluster, MT extends Record<string, Array<Record<string, any>>> = M> {
    ...
    start: () => void;
    sendInOrder: {
        <K extends keyof MT, V extends MT[K]>(type: K, value: V[0]): Promise<V[1]>;
        <K_1 extends keyof MT, V_1 extends MT[K_1]>(type: K_1, value: V_1[0], callback: (data: V_1[1]) => void): void;
    };
    send: {
